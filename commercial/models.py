...
class Sell_Property(MPTTModel):    
    ...
    def save(self, *args, **kwargs):
        ...
        super(Sell_Property, self).save(*args, **kwargs)
...
class Sell_Property_Images(models.Model):
    project=models.ForeignKey(Sell_Property,on_delete=models.CASCADE)
...
class Sell_Property_Comment(models.Model):
    STATUS = (
        ('New', 'New'),
        ('True', 'True'),
        ('False', 'False'),
